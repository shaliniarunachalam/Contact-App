...
//   const datetime = showdate.getDate()+'/'+showdate.getMonth()+'/'+showdate.getFullYear();
  const { state, dispatch } = useContext(ContactContext);

  // destruturing contacts and isLoading from state
  ...
  return (
    <Container className="mt-4">
      ...
      {contacts.length === 0 && !isLoading ?(
        <div className="text-primary text-large Center">No Contacts found in firebase</div>
      ):(
        <ListGroup>
          {/* object.entries always return a array of objects */}
